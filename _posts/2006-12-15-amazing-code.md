...
[原链接] (http://blog.renren.com/blog/24467433/201222744)

今天终于把机子整理好了，软件几乎都更新了一遍，现在可以好好轻松地上网看帖了。
发现个强悍的东西，与大家分享下，据说是世界编程大赛第一名写的程序世界编程大赛一等奖作品。
...
把这段代码复制下来存为文本文档,命名为1.txt（保存到＂C:\Documents and Settings\用户名＂下，进入cmd就可以直接输命令了）
在DOS或者CMD下用debug < 1.txt。进去是一个3D游戏的旋转界面，还有一段音乐，很强哦~
